...
function GTERM_LOAD()
{
	...
	GTERM_URL="https://raw.githubusercontent.com/rm-tic/provision-mint/master/gterm-profile.dconf"
...
function CLONE_REPO()
{
	REPO_DIR="/tmp/provision-mint"
	REPO_URL="https://github.com/rm-tic/provision-mint.git"
